let header_visi = document.getElementById("header_visi");
let menu = document.getElementById("menu");

window.onscroll = function () {
    if (window.pageYOffset >= 150) {
        header_visi.style.height = "200px";
        header_visi.style.width = "100%";
    } else {
        header_visi.style.height = "0px";
        // header_visi.style.width = "0px";
    }
}
